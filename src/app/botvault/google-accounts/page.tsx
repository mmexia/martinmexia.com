...
function ConnectionsContent() {
  ...
  useEffect(() => {
    if (searchParams.get('connected') === 'true') {
      ...
      window.history.replaceState({}, '', '/botvault/google-accounts');
  ...
  return (
    <DashboardShell>
      ...
      {success && <div style={{ background: 'rgba(0,200,100,0.15)', color: '#00c864', padding: '10px 16px', borderRadius: 8, marginBottom: 16, fontSize: 14 }}>{success}</div>}
...
export default function ConnectionsPage() {
  return (
    <Suspense fallback={<DashboardShell><div style={{ color: "var(--text-secondary)", padding: 40, textAlign: "center" }}>Loading...</div></DashboardShell>}>
      <ConnectionsContent />
    </Suspense>
  );
}
