...
export default function BotVaultDashboard() {
  ...
  const steps = [
    ...
    },
    {
      ...
      subItems: [
        { text: 'Keys', detail: 'API keys and secrets to access different services', link: '/keys' },
        { text: 'Google Accounts', detail: 'Allow your bot to access your Google workspace', link: '/google-accounts' },
        { text: 'Cards', detail: 'Give the power to buy to your bot', link: '/cards' },
      ],
      link: '/keys',
        ...
        {isEmpty ? (
          ...
          <>
            ...
            <div className="bv-quick-actions">
              <Link href="/botvault/keys" className="bv-action-btn">+ Add Key</Link>
