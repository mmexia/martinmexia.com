  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <nav style={{
        ...
        <Link href="/botvault/dashboard" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>{s.back}</Link>
...
{`GET /api/v1/credentials      → list available keys
GET /api/v1/credentials/{id}  → get a specific key`}
          </pre>
