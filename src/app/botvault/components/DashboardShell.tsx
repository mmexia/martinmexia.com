...
const NAV_ITEMS = [
  { href: '/botvault/dashboard', label: 'Dashboard', icon: '◆' },
  { href: '/botvault/bots', label: 'Bots', icon: '🤖' },
  { href: '/botvault/keys', label: 'Keys', icon: '🔑' },
  { href: '/botvault/google-accounts', label: 'Google Accounts', icon: '📧' },
  { href: '/botvault/cards', label: 'Cards', icon: '💳' },
  { href: '/botvault/skills', label: 'Skills', icon: '⚡' },
